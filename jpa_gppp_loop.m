...
base_dir_pl = 'E:\AG_Diplomarbeit\Preprocessed_on_Windows_Machine_swuaf_VBM8\';
% 
...
ss_level.gppi.FirstLVLModel={'results_abs_loss_3_noacc',};
...
ss_level.gppi.VOI={'VOI_8_times_mfg_l_BGG_3009_Sess_1.mat',};
...
ss_level.gppi.readScriptContrasts = 1;
...
ss_level.gppi.Tasks={'0' 'Task_on'}; % TASK EQUAL CONDITION
...
ss_level.gppi.Contrasts.name={'PPI_contrast1','PPI_contrast2'};
% define for each contrast the settings in  {} brackets!
ss_level.gppi.Contrasts.left={ 
    
    {'etoh_on_onsets_run1', 'etoh_off_onsets_run1', 'etoh_urge_onsets_run1', 'attn_on_onsets_run1'} % contrast 1
    {'etoh_on_onsets_run1', 'etoh_off_onsets_run1'} % contrast 2
...
ss_level.gppi.Contrasts.Weighted={0, 0};
ss_level.gppi.Contrasts.MinEvents={30, 30};
ss_level.gppi.Contrasts.STAT={'T', 'T'};

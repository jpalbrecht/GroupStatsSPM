...
sd_level.ttest.con = {'con_0001',}; % 
% 1st Level Contrasts Names
sd_level.ttest.conNames = {'1STLVLCON1'};  % 
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
sd_level.ttest.numberOfGrp = {'AD'};
%
...
% 1st Level Contrasts Names
sd_level.twottest.conNames = {'CON1'};
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
sd_level.twottest.numberOfGrp = {'AD' ,'PG'};
%
% _____________________________optional____________________________________
% Define the path to sjinfo.mat if different to generell settings
...
sd_level.twottest.contrastNames = {'HC>AUD','HC<AUD'};
...
sd_level.twottest.evalResAtlas = 'F:\fMRI\Programme\spm12\tpm\labels_Neuromorphometrics.xml';
% -------------------------------------------------------------------------
% view results
...
% -------------------------------------------------------------------------
% Evaluate Results
sd_level.twottest.evalResults = 1;
% -------------------------------------------------------------------------
% save batch and Settings-Struct
